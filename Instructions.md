...
- Your login: is _SNCUST006
- The password is _SNCUST006
...
- Run the following commands and ensure we get a 0000 return code:
  - `zowe endevor generate element DOGGOS06 --type COBOL --os --maxrc 0 --sn 1 --cb`
  - `zowe endevor generate element DOGGOS06 --type LNK --os --maxrc 0 --sn 1 --cb`
...
- To execute the application and see the output, we can call `zowe jobs`.
  - `zowe jobs submit dataset _MFCUST006.PUBLIC.JCL(NDRUNDOG) --vasc`
...
`zowe jobs submit data-set "CUST006.PUBLIC.JCL(NDRUNDOG)" --vasc`
...
The repository URL will be `https://github.com/McQuitty-Broadcom/Python-DevOps-06.git`
